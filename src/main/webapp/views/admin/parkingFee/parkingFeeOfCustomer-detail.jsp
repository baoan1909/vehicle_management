    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Thông tin chi tiết phí khách đăng ký</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Quản lý phí khách đăng ký</a></li>
                            <li class="breadcrumb-item active">Thông tin phí khách đăng ký</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div>
                        ...
                        <div class="col-md-10">
                            <div class="card card-cyan">
                                <div class="card-header">
                                    <h3 class="card-title">Thêm/ Sửa thông tin phí khách đăng ký</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="${pageContext.request.contextPath}/admin/parkingFeeOfCustomer/save" method="post">
                                    ...
                                    <div class="card-footer">
                                        <a class="btn btn-default" href="<%= request.getContextPath() %>/admin/parkingFeeOfCustomer?page=parkingFeeOfCustomer">Thoát</a>
