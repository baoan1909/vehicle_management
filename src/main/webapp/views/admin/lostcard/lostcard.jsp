    ...
    <div class="content-wrapper">
        <div class="content-header">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Mất thẻ</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    <form  method="get" action="${pageContext.request.contextPath}/admin/lost">
                        <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Bảng quản lý thông tin thẻ mất</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
